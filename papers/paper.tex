...
\includepdf[pages=1-6]{headers/header.pdf}
%\includepdf[pages=1-2]{headers/formal-header.pdf}
...
1. Nauki przyrodnicze, 1.2. Nauki o komputerach i informatyka, 1.2.a. Nauka o komputerach,
...
\noindent \textbf{Keywords:} cloud computing, data center, containerization, izolation, orchestration

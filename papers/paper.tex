...
\begin{flushleft}
Tytuł pracy w języku polskim: Przegląd i analiza zachowań  systemów szeregujących zadania w systemie Mesos w zależności od rodzaju wykonywanego zadania \\
\vspace*{0.4cm}
Tytuł pracy w języku angielskim: Mesos Scheduling System Evaluation \\
\end{flushleft}
...
Ja, niżej podpisany(a), wyrażam zgodę/nie wyrażam zgody* na korzystanie z mojej pracy dyplomowej zatytułowanej: Przegląd i analiza zachowań  systemów szeregujących zadania w systemie Mesos w zależności od rodzaju wykonywanego zadania 
